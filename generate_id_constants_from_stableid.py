...
if __name__ == "__main__":
    parser = ArgumentParser(description='Generate python enum from stableid.json.')
    parser.add_argument('--json_file', type=str, default=None,
                        help='Indicates the position of the file')

    args = parser.parse_args()
    filepath = args.json_file if args.json_file is not None else DATA_JSON[PF] 
